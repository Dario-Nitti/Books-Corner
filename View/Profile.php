...
<div class="container card">
    <div class="row">
        <div class="col-4">
            ...
            <a href="/myorders" id="orderac"  class="w3-bar-item w3-button"><strong>I Miei Ordini</strong></a><br>
            <a href="/payment" id="payac" class="w3-bar-item w3-button"><strong>Metodi di Pagamento</strong></a><br>
